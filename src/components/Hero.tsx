      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-light text-lg md:text-xl max-w-2xl mx-auto mb-8 animate-fade-up">
            We are a leading consultancy firm dedicated to delivering innovative solutions 
            and strategic guidance to businesses across Qatar and the MENA region. Our expertise 
            spans multiple sectors, helping organizations achieve sustainable growth and operational excellence.
          </p>
